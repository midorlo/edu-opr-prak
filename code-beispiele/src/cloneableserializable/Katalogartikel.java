 ...
 */
public abstract class Katalogartikel implements Serializable, Verkaufbares {
    ...
    public boolean passtZu(String suchbegriff) {
        ...
        java.util.StringTokenizer st =
                new java.util.StringTokenizer(this.gibSuchtext());
    ...
    /**
     * Liefert den Preis dieses Artikels.
     *
